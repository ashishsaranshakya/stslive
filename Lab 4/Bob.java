...
public class Bob {
    ...
    public static void main(String[] args) {
        try {
            ...
            String alicePublicSecret = in.readLine();
            System.out.println("Received Alice's public secret: " + alicePublicSecret);

            BigInteger publicSecret = G.modPow(privateKey, P);
            out.println(publicSecret);
            System.out.println("Bob sent his public secret: " + publicSecret);

            BigInteger aliceSecret = new BigInteger(alicePublicSecret);
            BigInteger commonSecret = aliceSecret.modPow(privateKey, P);
