...
public class DESServerWithRounds {
    ...
    public String encryptBlock(String plaintextBlock) throws Exception {
        ...
        for (int i = 0; i < 16; i++) {
            ...
            System.out.println("Encryption round " + (i + 1) + ": " + binToHex(mR + mL));
    ...
    public static void main(String[] args) {
        DESServerWithRounds des = new DESServerWithRounds
        ();
        try {
            ...
            while (true) {
                ...
                String cipherText = des.encrypt(k, utfToBin(p));

                BufferedReader in = new BufferedReader(new InputStreamReader(clientSocket.getInputStream()));
                PrintWriter out = new PrintWriter(clientSocket.getOutputStream(), true);

                System.out.println("Sent ciphertext: " + binToHex(cipherText));
                out.println(binToHex(cipherText));
