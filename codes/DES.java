...
public class DES {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Enter plaintext(UTF-8): ");
        String message = sc.nextLine(); 
        System.out.print("Enter key(UTF-8): ");
        ...
        if (message == null) {
            ...
            System.out.println("Improper key. Exiting.. ");
            System.exit(0);
        }
        String cipherText = des.encrypt(key1, utfToBin(message));
        System.out.println("Encrypted text: " + binToHex(cipherText));

        if (cipherText == null) {
            System.out.println("No data given to decrypt. Exiting..");
            System.exit(0);
        }
        String plainText = des.decrypt(key1, cipherText);
        System.out.println("Decrypted text: " + binToUTF(plainText));
