...
public class DESClientWithRounds {
    ...
    public String decryptBlock(String plaintextBlock) throws RuntimeException {
        ...
        for (int i = 16; i > 0; i--) {
            ...
            System.out.println("Decryption round " + i + ": " + binToHex(mR + mL));
    ...
    public static void main(String[] args) {
        DESClientWithRounds des = new DESClientWithRounds();
        try {
            ...
            while ((c = in.readLine()) != null) {
                System.out.println("Encrypted message recieved: " + c);
                ...
                String plainText = des.decrypt(k, hexToBin(c));
